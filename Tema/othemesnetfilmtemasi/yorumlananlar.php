<?php
/*
Template Name: othemes En Çok Yorumlananlar
*/
get_header();
?>
	   <div id="content">
...
<li><a href="<?php echo get_permalink($begenilenler) ?>" title="" onmouseover="document.getElementById('tip4' ).style.display = 'block';" onmouseout="document.getElementById('tip4' ).style.display = 'none';">&#x263A;</a></li>
		...
		<h1 class="ana_title23">En Çok Yorum Alan Filmler</h1>	
		</div><div class="clear"></div>
			<div class="anaicerik">
		<div id="tip1" style="display:none;font-size:14px;color:#fff;padding:9px;margin-top:-20px;background:#000;border-radius:5px;position:absolute;z-index:9999;">YENİ EKLENEN FİLMLERİ GÖSTER</div>
			<div id="tip2" style="display:none;font-size:14px;color:#fff;padding:9px;margin-top:-20px;background:#000;border-radius:5px;position:absolute;z-index:9999;">İZLENME SAYISINA GÖRE SIRALA</div>	
			<div id="tip3" style="display:none;font-size:14px;color:#fff;padding:9px;margin-top:-20px;background:#000;border-radius:5px;position:absolute;z-index:9999;">YORUM SAYISINA GÖRE SIRALA</div>
			<div id="tip4" style="display:none;font-size:14px;color:#fff;padding:9px;margin-top:-20px;background:#000;border-radius:5px;position:absolute;z-index:9999;">BEĞENME SAYISINA GÖRE SIRALA</div>
...
<?php } else { ?>
 ...
 <?php } ?>
<span class="puan"><?php comments_number('0 Yorum', '1 Yorum', '% Yorum' );?></span>
</a>
